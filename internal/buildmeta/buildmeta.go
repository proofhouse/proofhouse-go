...
// Build-time variables. The Justfile and goreleaser config both set these by
// passing -ldflags "-X github.com/proofhouse/proofhouse-go-tool/internal/buildmeta.<Var>=<value>"
// at build time.
